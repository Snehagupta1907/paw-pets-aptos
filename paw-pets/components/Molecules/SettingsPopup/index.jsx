...
export default function SettingsPopup(
    ...
    const handleDisconnect = async () => {
        try {
            // Call the disconnect function from context (this will handle Petra disconnect properly)
            if (onDisconnect) {
                onDisconnect();
            }
            ...
            <PopupDiv>
                ...
                >
                    ...
                    <BotCont>
                        <CusHr />
                        {currentUser ? <>
                            <Button type="button" text="DISCONNECT WALLET" onClick={handleDisconnect}
